...
$githubUrl = 'https://www.google.com/chart?chs=200x200&chld=M|0&cht=qr&chl=' . 'otpauth://totp/sysPass:prueba@syspass.org?secret=' . $InitalizationKey;
...
printf('<img class="google_qrcode" src="data:image/gif;base64,%s" alt="QR Code" />', base64_encode($data));
