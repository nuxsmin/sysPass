...
c);var a=d.parent(),b=$("#"+d.attr("id")+"_repeat");sysPassApp.util.password.output(h,d);h=new MaterialTextfield;a.find("input:password").val(c);a.addClass(h.CssClasses_.IS_DIRTY).removeClass(h.CssClasses_.IS_INVALID);0<b.length&&(b.val(c).parent().addClass(h.CssClasses_.IS_DIRTY).removeClass(h.CssClasses_.IS_INVALID),sysPassApp.encryptFormValue(b))})},g=function(){var a='<div id="box-complexity"><div>\n            <label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect" for="checkbox-chars">\n            <input type="checkbox" id="checkbox-chars" class="mdl-checkbox__input" name="checkbox-chars" checked/>\n            <span class="mdl-checkbox__label">'+
