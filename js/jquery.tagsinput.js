...
(function ($) {
    ...
    $.fn.removeTag = function (value, options) {
        ...
        this.each(function () {
            ...
            $.fn.tagsInput.importTags(this, str, options);
    ...
    $.fn.tagsInput = function (options) {
        ...
        this.each(function () {
            ...
            if ($(data.real_input).val() != '') {
                $.fn.tagsInput.importTags($(data.real_input), $(data.real_input).val(), {removeText: (settings.defaultRemoveText)});
            }
            if (settings.interactive) {
                ...
                data.removeWithBackspace && $(data.fake_input).bind('keydown', function (event) {
                    if (event.keyCode == 8 && $(this).val() == '') {
                        ...
                        $('#' + id).removeTag(escape(last_tag), {removeText: (settings.defaultRemoveText)});
                        $(this).trigger('focus');
                    }
                });
