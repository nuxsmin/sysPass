...
t={get:function(){h.info("sk:get");return $("#content").attr("data-sk")},set:function(a){h.info("sk:set");$("#content").attr("data-sk",a)}},w=function(){var a=$("#container");if(!a.hasClass("content-no-auto-resize")){var c=$("#content").height()+200;a.css("height",c)}},x=function(){$("html, body").animate({scrollTop:0},"slow")},y=function(a){window.location.replace(a)},z=function(b){var c=function(){return{actionId:b.data("action-id"),itemId:b.data("item-id"),sk:t.get()}},d={requestDoneAction:"",
...
!0===a.CHECK_UPDATES&&f.main.getUpdates();C();h.info("setupCallbacks");0<$("#boxLogin").length&&c.views.login();0<$("#searchbox").length&&c.views.search();0<$("footer").length&&c.views.footer()})})();return q};
