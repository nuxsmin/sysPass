...
var c=a.history.del();a.getActionCall(c,c.callback)}}).on("submit",".form-action",function(a){a.preventDefault();a=$(this);d.info("formAction");var c=a.attr("data-hash"),f=SparkMD5.hash(a.serialize(),!1);if(c===f)b.msg.ok(b.config().LANG[55]);else if(c=a.data("plugin"),c="undefined"!==typeof c?sysPass.Plugin[c](b):b.appActions(),f=a.data("onsubmit").split("/"),a.find("input[name='sk']").val(b.sk.get()),2===f.length)c[f[0]][f[1]](a);else c[f[0]](a)}).on("click",".btn-help",function(){var a=$(this),
