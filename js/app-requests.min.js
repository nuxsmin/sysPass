...
beforeSend:function(){!0===a.useLoading&&b.appTheme().loading.show(a.useFullLoading)},success:function(b){if("function"!==typeof c)return!0;!0===a.addHistory&&(a.callback=c,e.add(a));c(b)},error:function(c,f,e){"function"!==typeof g?(c=b.config().LANG[1]+"<p>"+e+f+"</p>",d.error(c),"html"===a.type&&$("#content").html(b.msg.html.error(e)),b.msg.error(c)):g()},complete:function(){!0===a.useLoading&&b.appTheme().loading.hide();b.appTheme().ajax.complete()}})},getActionPromise:function(a,c){d.info("getActionPromise");
var e=a.url.startsWith("http",0)||a.url.startsWith("https",0)?a.url:b.config().APP_ROOT+a.url;$.when($.ajax({dataType:a.type,url:e,method:a.method,async:a.async,data:a.data,cache:a.cache,processData:a.processData,contentType:a.contentType,timeout:a.timeout})).done(c)},getActionEvent:function(a,c,e){a=a.url.startsWith("http",0)||a.url.startsWith("https",0)?a.url:b.config().APP_ROOT+a.url;var f=new EventSource(a);f.addEventListener("message",function(a){a=JSON.parse(a.data);d.debug(a);1===a.end?(d.info("getActionEvent:Ending"),
f.close(),"function"===typeof e&&e(a)):"function"===typeof c&&c(a)});f.addEventListener("error",function(a){d.error("getActionEvent:Error occured");f.close()});return f},history:e}};
