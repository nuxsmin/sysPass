var $jscomp={scope:{},findInternal:function(c,d,g){c instanceof String&&(c=String(c));for(var e=c.length,f=0;f<e;f++){var l=c[f];if(d.call(g,l,f,c))return{i:f,v:l}}return{i:-1,v:void 0}}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(c,d,g){if(g.get||g.set)throw new TypeError("ES3 does not support getters and setters.");c!=Array.prototype&&c!=Object.prototype&&(c[d]=g.value)};
