...
final class BackupFiles
{
     ...
     */
    public function getAppBackupFileHandler(): FileHandler
    {
     ...
     * @return \SP\Storage\File\FileHandler
     */
    public function getDbBackupFileHandler(): FileHandler
    {
     ...
     * @throws \SP\Core\Exceptions\CheckException
     */
    public function getDbBackupArchiveHandler(): ArchiveHandler
    {
     ...
     * @throws \SP\Core\Exceptions\CheckException
     */
    public function getAppBackupArchiveHandler(): ArchiveHandler
    {
