...
interface ActionsInterface
{
    ...
    const NOTICE = 760;
    const NOTICE_USER = 761;
    const NOTICE_USER_VIEW = 7610;
    const NOTICE_USER_CREATE = 7611;
    const NOTICE_USER_EDIT = 7612;
    const NOTICE_USER_DELETE = 7613;
    const NOTICE_USER_CHECK = 7614;
    const NOTICE_USER_SEARCH = 7615;
    const CONFIG = 1000;
