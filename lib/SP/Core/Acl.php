...
class Acl implements ActionsInterface
{
    ...
    {
        self::$actionsInfo = [
            self::ACTION_ACC_SEARCH => ['acc_search', __('Buscar Cuentas', false), 'route' => 'account/search'],
            self::ACTION_ACC_VIEW => ['acc_view', __('Ver Cuenta', false), 'route' => 'account/view'],
            self::ACTION_ACC_COPY => ['acc_copy', __('Copiar Cuenta', false), 'route' => 'account/copy'],
            self::ACTION_ACC_NEW => ['acc_new', __('Nueva Cuenta', false), 'route' => 'account/create'],
            self::ACTION_ACC_EDIT => ['acc_edit', __('Editar Cuenta', false), 'route' => 'account/edit'],
            self::ACTION_ACC_EDIT_PASS => ['acc_editpass', __('Editar Clave de Cuenta', false), 'route' => 'account/editPass'],
            self::ACTION_ACC_VIEW_HISTORY => ['acc_viewhist', __('Ver Historial', false), 'route' => 'account/viewHistory'],
            self::ACTION_ACC_VIEW_PASS => ['acc_viewpass', __('Ver Clave', false), 'route' => 'account/viewPass'],
            self::ACTION_ACC_COPY_PASS => ['acc_copypass', __('Copiar Clave', false), 'route' => 'account/copyPass'],
            self::ACTION_ACC_DELETE => ['acc_delete', __('Eliminar Cuenta', false), 'route' => 'account/delete'],
            self::ACTION_ACC_FILES => ['acc_files', __('Archivos', false), 'route' => 'account/listFiles'],
            self::ACTION_ACC_REQUEST => ['acc_request', __('Peticiones', false), 'route' => 'account/request'],
            self::ACTION_MGM => ['mgm', __('Gestión Aplicación', false), 'route' => ''],
            self::ACTION_MGM_CATEGORIES => ['mgm_categories', __('Gestión Categorías', false), 'route' => 'category/index'],
            self::ACTION_MGM_CATEGORIES_SEARCH => ['mgm_categories_search', __('Buscar Categorías', false), 'route' => 'category/search'],
            self::ACTION_MGM_CATEGORIES_NEW => ['mgm_categories_add', __('Añadir Categoría', false)],
            self::ACTION_MGM_CATEGORIES_EDIT => ['mgm_categories_edit', __('Editar Categoría', false)],
            self::ACTION_MGM_CATEGORIES_DELETE => ['mgm_categories_delete', __('Eliminar Categoría', false)],
            self::ACTION_MGM_CUSTOMERS => ['mgm_customers', __('Gestión Clientes', false)],
            self::ACTION_MGM_CUSTOMERS_SEARCH => ['mgm_customers', __('Buscar Clientes', false)],
            self::ACTION_MGM_CUSTOMERS_NEW => ['mgm_customers_add', __('Añadir Cliente', false)],
            self::ACTION_MGM_CUSTOMERS_EDIT => ['mgm_customers_edit', __('Editar Cliente', false)],
            self::ACTION_MGM_CUSTOMERS_DELETE => ['mgm_customers_delete', __('Eliminar Cliente', false)],
            self::ACTION_MGM_CUSTOMFIELDS => ['mgm_customfields', __('Gestión Campos Personalizados', false)],
            self::ACTION_MGM_APITOKENS => ['mgm_apitokens', __('Gestión Autorizaciones API', false)],
            self::ACTION_MGM_FILES => ['mgm_files', __('Gestión de Archivos', false)],
            self::ACTION_MGM_ACCOUNTS => ['mgm_accounts', __('Gestión de Cuentas', false)],
            self::ACTION_MGM_TAGS => ['mgm_tags', __('Gestión de Etiquetas', false)],
            self::ACTION_MGM_PUBLICLINKS => ['mgm_publiclinks', __('Gestión de Enlaces Públicos', false)],
            self::ACTION_MGM_PUBLICLINKS_NEW => ['mgm_publiclinks_add', __('Crear Enlace Público', false), 'route' => 'publiclink/save'],
            self::ACTION_MGM_PUBLICLINKS_REFRESH => ['mgm_publiclinks_refresh', __('Actualizar Enlace Público', false), 'route' => 'publiclink/refresh'],
            self::ACTION_USR => ['usr', __('Gestión Usuarios', false)],
            self::ACTION_USR_USERS => ['usr_users', __('Gestión Usuarios', false)],
            self::ACTION_USR_GROUPS => ['usr_groups', __('Gestión Grupos', false)],
            self::ACTION_USR_PROFILES => ['usr_profiles', __('Gestión Perfiles', false)],
            self::ACTION_CFG => ['cfg', __('Configuración', false)],
            self::ACTION_CFG_GENERAL => ['cfg_general', __('Configuración General', false)],
            self::ACTION_CFG_ENCRYPTION => ['cfg_encryption', __('Encriptación', false)],
            self::ACTION_CFG_BACKUP => ['cfg_backup', __('Copia de Seguridad', false)],
            self::ACTION_CFG_EXPORT => ['cfg_export', __('Exportar', false)],
            self::ACTION_CFG_IMPORT => ['cfg_import', __('Importar', false)],
            self::ACTION_EVL => ['cfg_evl', __('Log de Eventos', false)]
        ];
    }
...
//            error_log('ACL_CACHE_MISS');
    ...
    public static function getActionInfo($action, $shortName = false, $translate = true)
    {
        ...
        return $translate ? __(self::$actionsInfo[$action][1]) : self::$actionsInfo[$action][1];
    }
}