...
[],c,e=window.location.href.slice(window.location.href.indexOf("?")+1).split("&"),f=0;f<e.length;f++)c=e[f].split("="),b.push(c[0]),b[c[0]]=c[1];return void 0!==a&&void 0!==b[a]?b[a]:b};return function(){f.info("init");y={actions:function(){return t},triggers:function(){return p},theme:function(){return B},sk:x,msg:e,log:f,passwordData:u,outputResult:C,checkPassLevel:F,encryptFormValue:z,fileUpload:G,redirect:A,scrollUp:J,setContentSize:K};q=$.extend({log:f,config:function(){return c},appTheme:function(){return B},
appActions:function(){return t},appTriggers:function(){return p},appRequests:function(){return v},appPlugins:function(){return r},evalAction:m,resizeImage:h},y);Object.freeze(y);Object.freeze(q);p=sysPass.Triggers(q);t=sysPass.Actions(q);v=sysPass.Requests(q);"function"===typeof sysPass.Theme&&(B=sysPass.Theme(q));M().then(function(){if(!I()&&(""!==c.PK&&n(),!1===c.COOKIES_ENABLED&&e.sticky(c.LANG[64]),w(),L(),0<c.PLUGINS.length)){f.info(c.PLUGINS);f.info("initPlugins");for(var a=0;a<c.PLUGINS.length;a++){var g=
c.PLUGINS[a];"function"===typeof sysPass.Plugin[g]&&(r[g]=sysPass.Plugin[g](q))}Object.freeze(r);!0===c.LOGGEDIN&&!0===c.CHECK_UPDATES&&b()}});return y}()};
