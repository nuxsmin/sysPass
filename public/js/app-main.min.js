...
var y=function(){g.info("getEnvironment");var a=window.location.pathname.split("/");b.APP_ROOT=window.location.protocol+"//"+window.location.host+function(){for(var b="",c=1;c<=a.length-2;c++)b+="/"+a[c];return b}();var c=m.getRequestOpts();c.url="/index.php?r=bootstrap/getEnvironment";c.method="get";c.useLoading=!1;c.data={isAjax:1};return m.getActionCall(c,function(a){b.LANG=a.lang;b.PK=a.pk;b.CHECK_UPDATES=a.check_updates;b.CRYPT.setPublicKey(a.pk);b.TIMEZONE=a.timezone;b.LOCALE=a.locale;b.DEBUG=
a.debug;b.MAX_FILE_SIZE=parseInt(a.max_file_size);b.COOKIES_ENABLED=a.cookies_enabled;b.PLUGINS=a.plugins;b.LOGGEDIN=a.loggedin;b.AUTHBASIC_AUTOLOGIN=a.authbasic_autologin;Object.freeze(b)})},r={current:"",get:function(){g.info("sk:get");return $("#container").attr("data-sk")},set:function(a){g.info("sk:set");$("#container").attr("data-sk",a);a.current=a}},z=function(){var a=$("#container");if(!a.hasClass("content-no-auto-resize")){var b=$("#content").height()+200;a.css("height",b)}},A=function(){$("html, body").animate({scrollTop:0},
"slow")},B=function(a){for(var b=[],d,g=window.location.href.slice(window.location.href.indexOf("?")+1).split("&"),h=0;h<g.length;h++)d=g[h].split("="),b.push(d[0]),b[d[0]]=d[1];return void 0!==a&&void 0!==b[a]?b[a]:b},C=function(){g.info("checkLogout");return"login/logout"===parseInt(B("r"))?(h.sticky(b.LANG[61],function(){u("index.php?r=login")}),!0):!1},u=function(a){window.location.replace(a)},D=function(a){var c={actionId:a.data("action-id"),itemId:a.data("item-id"),sk:r.get()},d={requestDoneAction:"",
setRequestData:function(a){$.extend(c,a)},getRequestData:function(){return c},beforeSendAction:"",url:""},k=function(a){if(void 0===d.url||""===d.url)return!1;var b=new FormData;b.append("inFile",a);b.append("isAjax",1);c.sk=r.get();Object.keys(c).forEach(function(a){b.append(a,c[a])});a=m.getRequestOpts();a.url=d.url;a.processData=!1;a.contentType=!1;a.data=b;m.getActionCall(a,function(a){var b=a.status;a=a.description;0===b?("function"===typeof d.requestDoneAction&&d.requestDoneAction(),h.ok(a)):
10===b?l.main.logout():h.error(a)})},f=function(c){if(5<c.length)h.error(b.LANG[17]+" (Max: 5)");else for(var d=0;d<c.length;d++){var t=c[d];if(t.size/1E3>b.MAX_FILE_SIZE)h.error(b.LANG[18]+"<br>"+t.name+" (Max: "+b.MAX_FILE_SIZE+")");else{var g;a:{g=t.name;for(var f=a.data("files-ext").toLowerCase().split(","),e=0;e<=f.length;e++)if(-1!==g.indexOf(f[e])){g=!0;break a}g=!1}g?k(c[d]):h.error(b.LANG[19]+"<br>"+t.name)}}},e=function(a){var b=$("#fileUploadForm");!1===a&&b.hide();a=b.find("input[type='file']");
a.on("change",function(){"function"===typeof d.beforeSendAction&&d.beforeSendAction();f(this.files)});return a};window.File&&window.FileList&&window.FileReader?function(){g.info("fileUpload:init");var b=e(!1);a.on("dragover dragenter",function(a){g.info("fileUpload:drag");a.stopPropagation();a.preventDefault()});a.on("drop",function(a){g.info("fileUpload:drop");a.stopPropagation();a.preventDefault();"function"===typeof d.beforeSendAction&&d.beforeSendAction();f(a.originalEvent.dataTransfer.files)});
a.on("click",function(){b.click()})}():e(!0);return d},E=function(a){g.info("checkPassLevel");f.passLength=a.val().length;w(zxcvbn(a.val()),a)},w=function(a,c){g.info("outputResult");var d=$(".passLevel-"+c.attr("id")),e=a.score;d.show();d.removeClass("weak good strong strongest");0===f.passLength?d.attr("title","").empty():f.passLength<f.minPasswordLength?d.attr("title",b.LANG[11]).addClass("weak"):0===e?d.attr("title",b.LANG[9]+" - "+a.feedback.warning).addClass("weak"):1===e||2===e?d.attr("title",
b.LANG[8]+" - "+a.feedback.warning).addClass("good"):3===e?d.attr("title",b.LANG[7]).addClass("strong"):4===e&&d.attr("title",b.LANG[10]).addClass("strongest")},v=function(a){g.info("encryptFormValue");var c=a.val();""!==c&&parseInt(a.attr("data-length"))!==c.length&&(c=b.CRYPT.encrypt(c),a.val(c),a.attr("data-length",c.length))},G=function(){g.info("initializeClipboard");if(clipboard.isSupported())$("body").on("click",".clip-pass-button",function(){var a=l.account.copypass($(this)).done(function(a){if(0!==
a.status)return h.out(a),!1;r.set(a.csrf)});!1!==a&&clipboard.copy(a.responseJSON.data.accpass).then(function(){h.ok(b.LANG[45])},function(a){h.error(b.LANG[46])})}).on("click",".dialog-clip-button",function(){var a=$(this.dataset.clipboardTarget);clipboard.copy(a.text()).then(function(){$(".dialog-text").removeClass("dialog-clip-copy");a.addClass("dialog-clip-copy")},function(a){h.error(b.LANG[46])})}).on("click",".clip-pass-icon",function(){var a=$(this.dataset.clipboardTarget);clipboard.copy(F(a.val())).then(function(){h.ok(b.LANG[45])},
