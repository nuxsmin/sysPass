var $jscomp={scope:{},findInternal:function(a,g,f){a instanceof String&&(a=String(a));for(var b=a.length,c=0;c<b;c++){var d=a[c];if(g.call(f,d,c,a))return{i:c,v:d}}return{i:-1,v:void 0}}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(a,g,f){if(f.get||f.set)throw new TypeError("ES3 does not support getters and setters.");a!=Array.prototype&&a!=Object.prototype&&(a[g]=f.value)};
...
d.charAt(Math.floor(Math.random()*(d.length-1)+0));this.config.passLength=e.length;"function"===typeof b&&b(e,zxcvbn(e))},output:function(b,c){a.info("password:outputResult");var d=$("#password-level-"+c.attr("id")),e=b.score;d.removeClass("weak good strong strongest");0===this.config.passLength?d.attr("data-level-msg",""):this.config.passLength<this.config.minPasswordLength?d.attr("data-level-msg",sysPassApp.config.LANG[11]).addClass("weak"):0===e?d.attr("data-level-msg",sysPassApp.config.LANG[9]+
" - "+b.feedback.warning).addClass("weak"):1===e||2===e?d.attr("data-level-msg",sysPassApp.config.LANG[8]+" - "+b.feedback.warning).addClass("good"):3===e?d.attr("data-level-msg",sysPassApp.config.LANG[7]).addClass("strong"):4===e&&d.attr("data-level-msg",sysPassApp.config.LANG[10]).addClass("strongest")},checkLevel:function(b){a.info("password:checkPassLevel");this.config.passLength=b.val().length;g.output(zxcvbn(b.val()),b)}},f={state:{lastHash:""},send:function(b,c,d){a.info("sendNotification");
...
.9*$(window).width(),d=.9*$(window).height(),e={width:a.width(),height:a.height()},f={calc:0,main:0,secondary:0,factor:.9,rel:e.width/e.height},g=function(a){a.main>a.secondary?a.calc=a.main/a.rel:a.main<a.secondary&&(a.calc=a.main*a.rel);a.calc>a.secondary&&(a.main*=a.factor,g(a));return a},h=function(){f.main=d;f.secondary=b;var c=g(f);a.css({width:c.calc,height:c.main});e.width=c.calc;e.height=c.main};e.width>b?function(){f.main=b;f.secondary=d;var c=g(f);a.css({width:c.main,height:c.calc});e.width=
c.main;e.height=c.calc}():e.height>d&&h();return e},fileUpload:function(b){var c=function(a){var b=$("#fileUploadForm");!1===a&&b.hide();a=b.find("input[type='file']");a.on("change",function(){"function"===typeof e.beforeSendAction&&e.beforeSendAction();g(this.files)});return a},d={actionId:b.data("action-id"),itemId:b.data("item-id"),sk:sysPassApp.sk.get()},e={requestDoneAction:"",setRequestData:function(a){$.extend(d,a)},getRequestData:function(){return d},beforeSendAction:"",url:"",allowedMime:[]},
f=function(a){if(void 0===e.url||""===e.url)return!1;var b=new FormData;b.append("inFile",a);b.append("isAjax",1);d.sk=sysPassApp.sk.get();Object.keys(d).forEach(function(a){b.append(a,d[a])});a=sysPassApp.requests.getRequestOpts();a.url=e.url;a.processData=!1;a.contentType=!1;a.data=b;sysPassApp.requests.getActionCall(a,function(a){var b=a.status;a=a.description;0===b?("function"===typeof e.requestDoneAction&&e.requestDoneAction(),sysPassApp.msg.ok(a)):10===b?sysPassApp.appActions().main.logout():
sysPassApp.msg.error(a)})},g=function(a){if(5<a.length)sysPassApp.msg.error(sysPassApp.config.LANG[17]+" (Max: 5)");else for(var b=0;b<a.length;b++){var c=a[b];if(c.size/1E3>sysPassApp.config.FILES.MAX_SIZE)sysPassApp.msg.error(sysPassApp.config.LANG[18]+"<br>"+c.name+" (Max: "+sysPassApp.config.FILES.MAX_SIZE+")");else{var d;a:if(d=c.type,""===d)d=!0;else{var g=void 0;for(g in e.allowedMime)if(-1!==d.indexOf(e.allowedMime[g])){d=!0;break a}d=!1}d?f(a[b]):sysPassApp.msg.error(sysPassApp.config.LANG[19]+
"<br>"+c.type)}}};window.File&&window.FileList&&window.FileReader?function(){a.info("fileUpload:init");var d=c(!1);b.on("dragover dragenter",function(b){a.info("fileUpload:drag");b.stopPropagation();b.preventDefault()});b.on("drop",function(b){a.info("fileUpload:drop");b.stopPropagation();b.preventDefault();"function"===typeof e.beforeSendAction&&e.beforeSendAction();g(b.originalEvent.dataTransfer.files)});b.on("click",function(){d.click()})}():c(!0);return e},scrollUp:function(){$("html, body").animate({scrollTop:0},
