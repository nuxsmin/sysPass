...
return d}function e(a,c){if("undefined"===typeof a&&"undefined"===typeof c)for(var d=0;d<l.length;d++)e(l[d].className,l[d].cssClass);else{"undefined"===typeof c&&(d=b(a))&&(c=d.cssClass);for(var d=document.querySelectorAll("."+c),g=0;g<d.length;g++)f(d[g],a)}}function f(c,e){if(!("object"===typeof c&&c instanceof Element))throw Error("Invalid argument provided to upgrade MDL element.");var p=g("mdl-componentupgrading",!0,!0);c.dispatchEvent(p);if(!p.defaultPrevented){var p=a(c),n=[];if(e)d(c,e)||
n.push(b(e));else{var f=c.classList;l.forEach(function(b){f.contains(b.cssClass)&&-1===n.indexOf(b)&&!d(c,b.className)&&n.push(b)})}for(var t=0,x=n.length,h;t<x;t++){if(h=n[t]){p.push(h.className);c.setAttribute("data-upgraded",p.join(","));var k=new h.classConstructor(c);k.mdlComponentConfigInternal_=h;r.push(k);for(var m=0,q=h.callbacks.length;m<q;m++)h.callbacks[m](c);h.widget&&(c[h.className]=k)}else throw Error("Unable to find a registered component for the given class.");h=g("mdl-componentupgraded",
!0,!1);c.dispatchEvent(h)}}}function h(b){Array.isArray(b)||(b=b instanceof Element?[b]:Array.prototype.slice.call(b));for(var a=0,c=b.length,d;a<c;a++)d=b[a],d instanceof HTMLElement&&(f(d),0<d.children.length&&h(d.children))}function k(b){if(b){var a=r.indexOf(b);r.splice(a,1);var a=b.element_.getAttribute("data-upgraded").split(","),c=a.indexOf(b.mdlComponentConfigInternal_.classAsString);a.splice(c,1);b.element_.setAttribute("data-upgraded",a.join(","));a=g("mdl-componentdowngraded",!0,!1);b.element_.dispatchEvent(a)}}
var l=[],r=[];return{upgradeDom:e,upgradeElement:f,upgradeElements:h,upgradeAllRegistered:function(){for(var b=0;b<l.length;b++)e(l[b].className)},registerUpgradedCallback:function(a,c){var d=b(a);d&&d.callbacks.push(c)},register:function(a){var c=!0;if("undefined"!==typeof a.widget||"undefined"!==typeof a.widget)c=a.widget||a.widget;var d={classConstructor:a.constructor||a.constructor,className:a.classAsString||a.classAsString,cssClass:a.cssClass||a.cssClass,widget:c,callbacks:[]};l.forEach(function(b){if(b.cssClass===
...
function(){"classList"in document.createElement("div")&&"querySelector"in document&&"addEventListener"in window&&Array.prototype.forEach?(document.documentElement.classList.add("mdl-js"),e.upgradeAllRegistered()):(e.upgradeElement=function(){},e.register=function(){})});Date.now||(Date.now=function(){return(new Date).getTime()},Date.now=Date.now);for(var a=["webkit","moz"],m=0;m<a.length&&!window.requestAnimationFrame;++m){var q=a[m];window.requestAnimationFrame=window[q+"RequestAnimationFrame"];
window.cancelAnimationFrame=window[q+"CancelAnimationFrame"]||window[q+"CancelRequestAnimationFrame"];window.requestAnimationFrame=window.requestAnimationFrame;window.cancelAnimationFrame=window.cancelAnimationFrame}if(/iP(ad|hone|od).*OS 6/.test(window.navigator.userAgent)||!window.requestAnimationFrame||!window.cancelAnimationFrame){var v=0;window.requestAnimationFrame=function(b){var a=Date.now(),d=Math.max(v+16,a);return setTimeout(function(){b(v=d)},d-a)};window.cancelAnimationFrame=clearTimeout;
...
function(){this.element_.classList.contains(this.CssClasses_.MDL_JS_RIPPLE_EFFECT)&&this.element_.classList.add(this.CssClasses_.MDL_JS_RIPPLE_EFFECT_IGNORE_EVENTS);this.tabs_=this.element_.querySelectorAll("."+this.CssClasses_.TAB_CLASS);this.panels_=this.element_.querySelectorAll("."+this.CssClasses_.PANEL_CLASS);for(var a=0;a<this.tabs_.length;a++)new w(this.tabs_[a],this);this.element_.classList.add(this.CssClasses_.UPGRADED_CLASS)};a.prototype.resetTabState_=function(){for(var a=0;a<this.tabs_.length;a++)this.tabs_[a].classList.remove(this.CssClasses_.ACTIVE_CLASS)};
...
this.boundMouseLeaveAndScrollHandler=this.hideTooltip_.bind(this),this.forElement_.addEventListener("mouseenter",this.boundMouseEnterHandler,!1),this.forElement_.addEventListener("touchend",this.boundMouseEnterHandler,!1),this.forElement_.addEventListener("mouseleave",this.boundMouseLeaveAndScrollHandler,!1),window.addEventListener("scroll",this.boundMouseLeaveAndScrollHandler,!0),window.addEventListener("touchstart",this.boundMouseLeaveAndScrollHandler,{passive:true}))}};e.register({constructor:a,classAsString:"MaterialTooltip",
...
"true"),a.setAttribute("aria-expanded","false"))};a.prototype.toggleDrawer=a.prototype.toggleDrawer;a.prototype.init=function(){if(this.element_){var a=document.createElement("div");a.classList.add(this.CssClasses_.CONTAINER);var c=this.element_.querySelector(":focus");this.element_.parentElement.insertBefore(a,this.element_);this.element_.parentElement.removeChild(this.element_);a.appendChild(this.element_);c&&c.focus();for(var c=this.element_.childNodes,d=c.length,g=0;g<d;g++){var e=c[g];e.classList&&
e.classList.contains(this.CssClasses_.HEADER)&&(this.header_=e);e.classList&&e.classList.contains(this.CssClasses_.DRAWER)&&(this.drawer_=e);e.classList&&e.classList.contains(this.CssClasses_.CONTENT)&&(this.content_=e)}window.addEventListener("pageshow",function(a){a.persisted&&(this.element_.style.overflowY="hidden",requestAnimationFrame(function(){this.element_.style.overflowY=""}.bind(this)))}.bind(this),!1);this.header_&&(this.tabBar_=this.header_.querySelector("."+this.CssClasses_.TAB_BAR));
...
a.classList.add(this.CssClasses_.TAB_CONTAINER);this.header_.insertBefore(a,this.tabBar_);this.header_.removeChild(this.tabBar_);var f=document.createElement("div");f.classList.add(this.CssClasses_.TAB_BAR_BUTTON);f.classList.add(this.CssClasses_.TAB_BAR_LEFT_BUTTON);c=document.createElement("i");c.classList.add(this.CssClasses_.ICON);c.textContent=this.Constant_.CHEVRON_LEFT;f.appendChild(c);f.addEventListener("click",function(){this.tabBar_.scrollLeft-=this.Constant_.TAB_SCROLL_PIXELS}.bind(this));
var h=document.createElement("div");h.classList.add(this.CssClasses_.TAB_BAR_BUTTON);h.classList.add(this.CssClasses_.TAB_BAR_RIGHT_BUTTON);c=document.createElement("i");c.classList.add(this.CssClasses_.ICON);c.textContent=this.Constant_.CHEVRON_RIGHT;h.appendChild(c);h.addEventListener("click",function(){this.tabBar_.scrollLeft+=this.Constant_.TAB_SCROLL_PIXELS}.bind(this));a.appendChild(f);a.appendChild(this.tabBar_);a.appendChild(h);var k=function(){0<this.tabBar_.scrollLeft?f.classList.add(this.CssClasses_.IS_ACTIVE):
...
a);this.tabBar_.classList.contains(this.CssClasses_.JS_RIPPLE_EFFECT)&&this.tabBar_.classList.add(this.CssClasses_.RIPPLE_IGNORE_EVENTS);a=this.tabBar_.querySelectorAll("."+this.CssClasses_.TAB);c=this.content_.querySelectorAll("."+this.CssClasses_.PANEL);for(d=0;d<a.length;d++)new u(a[d],a,c,this)}this.element_.classList.add(this.CssClasses_.IS_UPGRADED)}};window.MaterialLayoutTab=u;e.register({constructor:a,classAsString:"MaterialLayout",cssClass:"mdl-js-layout"});a=function(a){this.element_=a;
this.init()};window.MaterialDataTable=a;a.prototype.Constant_={};a.prototype.CssClasses_={DATA_TABLE:"mdl-data-table",SELECTABLE:"mdl-data-table--selectable",SELECT_ELEMENT:"mdl-data-table__select",IS_SELECTED:"is-selected",IS_UPGRADED:"is-upgraded"};a.prototype.selectRow_=function(a,c,d){if(c)return function(){a.checked?c.classList.add(this.CssClasses_.IS_SELECTED):c.classList.remove(this.CssClasses_.IS_SELECTED)}.bind(this);if(d)return function(){var b,c;if(a.checked)for(b=0;b<d.length;b++)c=d[b].querySelector("td").querySelector(".mdl-checkbox"),
c.MaterialCheckbox.check(),d[b].classList.add(this.CssClasses_.IS_SELECTED);else for(b=0;b<d.length;b++)c=d[b].querySelector("td").querySelector(".mdl-checkbox"),c.MaterialCheckbox.uncheck(),d[b].classList.remove(this.CssClasses_.IS_SELECTED)}.bind(this)};a.prototype.createCheckbox_=function(a,c){var b=document.createElement("label");b.className=["mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect",this.CssClasses_.SELECT_ELEMENT].join(" ");var g=document.createElement("input");g.type="checkbox";g.classList.add("mdl-checkbox__input");
a?(g.checked=a.classList.contains(this.CssClasses_.IS_SELECTED),g.addEventListener("change",this.selectRow_(g,a))):c&&g.addEventListener("change",this.selectRow_(g,null,c));b.appendChild(g);e.upgradeElement(b,"MaterialCheckbox");return b};a.prototype.init=function(){if(this.element_){var a=this.element_.querySelector("th"),c=Array.prototype.slice.call(this.element_.querySelectorAll("tbody tr")),d=Array.prototype.slice.call(this.element_.querySelectorAll("tfoot tr")),c=c.concat(d);if(this.element_.classList.contains(this.CssClasses_.SELECTABLE)){var d=
document.createElement("th"),e=this.createCheckbox_(null,c);d.appendChild(e);a.parentElement.insertBefore(d,a);for(a=0;a<c.length;a++)if(d=c[a].querySelector("td")){e=document.createElement("td");if("TBODY"===c[a].parentNode.nodeName.toUpperCase()){var f=this.createCheckbox_(c[a]);e.appendChild(f)}c[a].insertBefore(e,d)}this.element_.classList.add(this.CssClasses_.IS_UPGRADED)}}};e.register({constructor:a,classAsString:"MaterialDataTable",cssClass:"mdl-js-data-table"});a=function(a){this.element_=
a;this.init()};window.MaterialRipple=a;a.prototype.Constant_={INITIAL_SCALE:"scale(0.0001, 0.0001)",INITIAL_SIZE:"1px",INITIAL_OPACITY:"0.4",FINAL_OPACITY:"0",FINAL_SCALE:""};a.prototype.CssClasses_={RIPPLE_CENTER:"mdl-ripple--center",RIPPLE_EFFECT_IGNORE_EVENTS:"mdl-js-ripple-effect--ignore-events",RIPPLE:"mdl-ripple",IS_ANIMATING:"is-animating",IS_VISIBLE:"is-visible"};a.prototype.downHandler_=function(a){if(!this.rippleElement_.style.width&&!this.rippleElement_.style.height){var b=this.element_.getBoundingClientRect();
this.boundHeight=b.height;this.boundWidth=b.width;this.rippleSize_=2*Math.sqrt(b.width*b.width+b.height*b.height)+2;this.rippleElement_.style.width=this.rippleSize_+"px";this.rippleElement_.style.height=this.rippleSize_+"px"}this.rippleElement_.classList.add(this.CssClasses_.IS_VISIBLE);if("mousedown"===a.type&&this.ignoringMouseDown_)this.ignoringMouseDown_=!1;else if("touchstart"===a.type&&(this.ignoringMouseDown_=!0),!(0<this.getFrameCount())){this.setFrameCount(1);b=a.currentTarget.getBoundingClientRect();
if(0===a.clientX&&0===a.clientY)a=Math.round(b.width/2),b=Math.round(b.height/2);else{var d=void 0!==a.clientY?a.clientY:a.touches[0].clientY;a=Math.round((void 0!==a.clientX?a.clientX:a.touches[0].clientX)-b.left);b=Math.round(d-b.top)}this.setRippleXY(a,b);this.setRippleStyles(!0);window.requestAnimationFrame(this.animFrameHandler.bind(this))}};a.prototype.upHandler_=function(a){a&&2!==a.detail&&window.setTimeout(function(){this.rippleElement_.classList.remove(this.CssClasses_.IS_VISIBLE)}.bind(this),
...
this.boundDownHandler,{passive:true}),this.boundUpHandler=this.upHandler_.bind(this),this.element_.addEventListener("mouseup",this.boundUpHandler),this.element_.addEventListener("mouseleave",this.boundUpHandler),this.element_.addEventListener("touchend",this.boundUpHandler),this.element_.addEventListener("blur",this.boundUpHandler),this.getFrameCount=function(){return this.frameCount_},this.setFrameCount=function(a){this.frameCount_=a},this.getRippleElement=function(){return this.rippleElement_},this.setRippleXY=
function(a,b){this.x_=a;this.y_=b},this.setRippleStyles=function(b){if(null!==this.rippleElement_){var c,e="translate("+this.x_+"px, "+this.y_+"px)";b?c=this.Constant_.INITIAL_SCALE:(c=this.Constant_.FINAL_SCALE,a&&(e="translate("+this.boundWidth/2+"px, "+this.boundHeight/2+"px)"));c="translate(-50%, -50%) "+e+c;this.rippleElement_.style.webkitTransform=c;this.rippleElement_.style.msTransform=c;this.rippleElement_.style.transform=c;b?this.rippleElement_.classList.remove(this.CssClasses_.IS_ANIMATING):
