...
function(){$(this).attr("title",b.val())});e.find(".reset").on("click",function(){b.val("");m.val("");componentHandler.upgradeDom()});b.attr("data-pass-upgraded","true")}});b.find(".passwordfield__input-show").each(function(){var b=$(this),e=b.parent(),b=b.attr("id");e.after('<i class="showpass material-icons" title="'+a.config().LANG[32]+'" data-targetid="'+b+'">remove_red_eye</i>')})},n=function(b){f.info("setupDatePicker");var c={format:"YYYY-MM-DD",lang:a.config().LOCALE.substr(0,2),time:!1,cancelText:a.config().LANG[44],
...
a.on("change",function(){var b;b=e(a.val());a.parent().find("input[name='passworddatechange_unix']").val(b)})})},p=function(){var a=$("#actions-bar");if(0<a.length){var c=a.find("#actions-bar-logo"),e=!1,d={on:function(){a.css({backgroundColor:"rgba(255, 255, 255, .75)",borderBottom:"1px solid #ccc"});c.show();e=!0},off:function(){a.css({backgroundColor:"transparent",borderBottom:"none"});c.hide();e=!1}};$(window).on("scroll",function(){var b=$(this).scrollTop()>a.height();if(b&&!e)d.on();else!b&&
e&&d.off()}).on("resize",function(){if(0<a.offset().top)d.on()});if(0<a.offset().top)d.on()}};(function(){jQuery.extend(jQuery.fancybox.defaults,{type:"ajax",autoWidth:!0,autoHeight:!0,autoResize:!0,autoCenter:!0,fitToView:!1,minHeight:50,padding:0,helpers:{overlay:{css:{background:"rgba(0, 0, 0, 0.3)"}}},keys:{close:[27]},afterShow:function(){$("#fancyContainer").find("input[type='text']:visible:first").focus()}});c();p()})();return{activeTooltip:c,passwordDetect:l,password:g,viewsTriggers:{search:function(){var b=
...
$("#loading").removeClass("is-active")}},ajax:{complete:function(){componentHandler.upgradeDom()}}}};
