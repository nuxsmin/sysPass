...
sysPass.Theme=function(a){var f=a.log,c=function(a){"undefined"===typeof a&&(a=$("body"));a.find(".active-tooltip").tooltip({content:function(){return $(this).attr("title")},tooltipClass:"tooltip"})},g=function(b){for(var k=0,e="",d;k<a.passwordData.complexity.numlength;){d=Math.floor(100*Math.random())%94+33;if(!a.passwordData.complexity.symbols){if(33<=d&&47>=d)continue;if(58<=d&&64>=d)continue;if(91<=d&&96>=d)continue;if(123<=d&&126>=d)continue}!a.passwordData.complexity.numbers&&48<=d&&57>=d||
!a.passwordData.complexity.uppercase&&65<=d&&90>=d||(k++,e+=String.fromCharCode(d))}$("#viewPass").attr("title",e);var m=zxcvbn(e);a.passwordData.passLength=e.length;b?(k=b.parent(),d=$("#"+b.attr("id")+"R"),a.outputResult(m,b),b=new MaterialTextfield,k.find("input:password").val(e),k.addClass(b.CssClasses_.IS_DIRTY).removeClass(b.CssClasses_.IS_INVALID),d.val(e).parent().addClass(b.CssClasses_.IS_DIRTY).removeClass(b.CssClasses_.IS_INVALID),a.encryptFormValue(d),k.find("#passLevel").show(500)):(a.outputResult(m),
...
function(){$(this).attr("title",b.val())});e.find(".reset").on("click",function(){b.val("");m.val("");componentHandler.upgradeDom()});b.attr("data-pass-upgraded","true")}});b.find(".passwordfield__input-show").each(function(){var b=$(this),e=b.parent(),b=b.attr("id");e.after('<i class="showpass material-icons" title="'+a.config().LANG[32]+'" data-targetid="'+b+'">remove_red_eye</i>')})},n=function(b){f.info("setupDatePicker");var c={format:"YYYY-MM-DD",lang:"en",weekStart:0,time:!1,cancelText:a.config().LANG[44],
...
p=function(){var a=$("#actions-bar");if(0<a.length){var c=a.find("#actions-bar-logo"),e=!1,d={on:function(){a.css({backgroundColor:"rgba(255, 255, 255, .75)",borderBottom:"1px solid #ccc"});c.show();e=!0},off:function(){a.css({backgroundColor:"transparent",borderBottom:"none"});c.hide();e=!1}};$(window).on("scroll",function(){var b=$(this).scrollTop()>a.height();if(b&&!e)d.on();else!b&&e&&d.off()}).on("resize",function(){if(0<a.offset().top)d.on()});if(0<a.offset().top)d.on()}};(function(){jQuery.extend(jQuery.fancybox.defaults,
{type:"ajax",autoWidth:!0,autoHeight:!0,autoResize:!0,autoCenter:!0,fitToView:!1,minHeight:50,padding:0,helpers:{overlay:{css:{background:"rgba(0, 0, 0, 0.3)"}}},keys:{close:[27]},afterShow:function(){$("#fancyContainer").find("input[type='text']:visible:first").focus()}});c();p()})();return{activeTooltip:c,passwordDetect:l,password:g,viewsTriggers:{search:function(){var b=$("#frmSearch"),c=$("#res-content");b.find(".icon-searchfav").on("click",function(){var c=$(this).find("i"),d=b.find("input[name='searchfav']");
0==d.val()?(c.addClass("mdl-color-text--amber-A200"),c.attr("title",a.config().LANG[53]),d.val(1)):(c.removeClass("mdl-color-text--amber-A200"),c.attr("title",a.config().LANG[52]),d.val(0));b.submit()});var e=b.find("#tags")[0],d=b.find("i.show-filter");c.on("click","#data-search-header .sort-down,#data-search-header .sort-up",function(){var b=$(this);b.parent().find("a").addClass("filterOn");a.appActions().account.sort(b)}).on("click","#search-rows i.icon-favorite",function(){var b=$(this);a.appActions().account.savefavorite(b,
function(){"on"===b.data("status")?(b.addClass("mdl-color-text--amber-A100"),b.attr("title",a.config().LANG[50]),b.html("star")):(b.removeClass("mdl-color-text--amber-A100"),b.attr("title",a.config().LANG[49]),b.html("star_border"))})}).on("click","#search-rows span.tag",function(){0==d.data("state")&&d.trigger("click");e.selectize.addItem($(this).data("tag-id"))});d.on("click",function(){var a=$(this),c=b.find(".search-filters-tags");0==a.data("state")?(c.show("slow"),a.data("state","1"),a.html(a.data("icon-up"))):
(c.hide("slow"),a.data("state","0"),a.html(a.data("icon-down")))});0<e.selectedOptions.length&&d.trigger("click")},common:function(a){l(a);c(a);n(a);a.find(".download").button({icons:{primary:"ui-icon-arrowthickstop-1-s"}})}},loading:{show:function(){$("#wrap-loading").show();$("#loading").addClass("is-active")},hide:function(){$("#wrap-loading").hide();$("#loading").removeClass("is-active")}},ajax:{complete:function(){componentHandler.upgradeDom()}}}};
