...
(b.removeClass("mdl-color-text--amber-A100"),b.attr("title",a.config().LANG[49]),b.html("star_border"))})}).on("click","#search-rows span.tag",function(){0==c.data("state")&&c.trigger("click");e.selectize.addItem($(this).data("tag-id"))});c.on("click",function(){var a=$(this),c=b.find(".search-filters-tags");0==a.data("state")?(c.show("blind","slow"),a.data("state","1"),a.html(a.data("icon-up"))):(c.hide("blind","slow"),a.data("state","0"),a.html(a.data("icon-down")))});0<e.selectedOptions.length&&
c.trigger("click")},common:function(a){m(a);n(a)}},loading:{show:function(){$("#wrap-loading").show();$("#loading").addClass("is-active")},hide:function(){$("#wrap-loading").hide();$("#loading").removeClass("is-active")}},ajax:{complete:function(){f.info("ajax:complete");componentHandler.upgradeDom()}},html:{getList:function(a){var b=$('<ul class="ldap-list-item mdl-list"></ul>'),d=$('<li class="mdl-list__item"></li>'),c=$('<span class="mdl-list__item-primary-content"></span>');a.forEach(function(a){var e=
c.clone();e.append('<i class="material-icons mdl-list__item-icon">person</i>');e.append(a);a=d.clone().append(e);b.append(a)});return b},tabs:{add:function(a,d,e,c){a=$(a);var b="";1===c&&(a.parent().find("#tabs-"+d).addClass("is-active"),b="is-active");a.append('<a href="#tabs-'+d+'" class="mdl-tabs__tab '+b+'">'+e+"</a>")}}}}};
