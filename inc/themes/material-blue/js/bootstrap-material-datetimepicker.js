    ...
    Plugin.prototype =
    {
        ...
        initTemplate: function () {
            this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                ...
                '<button class="dtp-btn-now btn btn-flat hidden mdl-button mdl-js-button">' + this.params.nowText + '</button>' +
                '<button class="dtp-btn-clear btn btn-flat hidden mdl-button mdl-js-button">' + this.params.clearText + '</button>' +
                '<button class="dtp-btn-cancel btn btn-flat mdl-button mdl-js-button mdl-button--primary">' + this.params.cancelText + '</button>' +
                '<button class="dtp-btn-ok btn btn-flat mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--primary">' + this.params.okText + '</button>' +
                '<div class="clearfix"></div>' +
                '</div>' +
                '</div>' +
                '</div>';
