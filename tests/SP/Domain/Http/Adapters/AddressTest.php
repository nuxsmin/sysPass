...
namespace SP\Tests\Domain\Http\Adapters;
...
class AddressTest extends UnitaryTestCase
{
    ...
    public function testCheckWithCidr(string $address, string $inAddress, int $inMask, bool $expected)
    {
        $this->assertEquals(
            $expected,
            Address::check(
